...
# multiplies one by the other
# returns the result
def multiply_number_strings(n1, n2)
    return (n1.to_i * n2.to_i)
end
...
def rev_sym_caps(arg)
    return arg.reverse.upcase.to_sym
end
